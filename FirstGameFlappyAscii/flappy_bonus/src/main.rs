...
// Create obstacle
struct Obstacle {
    // defining their position in world-space (to match the player’s world-space x value)
    x: i32,
    // gap_y defines the center of the gap through which the dragon may pass
    gap_y: i32,
    // defines the length of the gap in the obstacle
    // the maximum (obtained via i32::max) of 20 minus the player’s score, or 2 to increasing difficulty
    size: i32
}
...
impl Obstacle {
    ...
    // calculate if the dragon has crashed into a wall
